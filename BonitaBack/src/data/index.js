...
// GiftCard --> Receipt (sin constraint para permitir datos huérfanos)
GiftCard.belongsTo(Receipt, { 
  foreignKey: 'id_receipt',
  constraints: false // No crear foreign key constraint en DB
});
Receipt.hasMany(GiftCard, { 
  foreignKey: 'id_receipt',
  constraints: false // No crear foreign key constraint en DB
});
