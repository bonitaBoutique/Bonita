...
const ExpenseList = () => {
  ...
  if (loading) return <div className="text-center py-8">Cargando gastos...</div>;
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-6 bg-gray-300 rounded-lg shadow-xl">
        ...
        <table className="min-w-full bg-white rounded-lg shadow">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="py-3 px-4 border-b font-semibold text-gray-700">Tipo</th>
              <th className="py-3 px-4 border-b font-semibold text-gray-700">Descripción</th>
              <th className="py-3 px-4 border-b font-semibold text-gray-700">Método de Pago</th>
              <th className="py-3 px-4 border-b font-semibold text-gray-700">Monto</th>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        ...
        <p className="text-sm text-blue-800">
          <strong>Página actual:</strong> {currentPage} de {Math.ceil(expenses.length / itemsPerPage)}
        </p>
      </div>
    </div>
  );
