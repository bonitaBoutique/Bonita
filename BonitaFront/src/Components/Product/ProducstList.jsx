...
const ProductsList = () => {
  ...
  if (loading && products.length === 0) {
    // Muestra loading solo en la carga inicial
    return (
        ...
        <div className="mx-auto max-w-7xl w-full px-4 py-16 sm:px-6 lg:px-8">
          {uniqueGroups.length === 0 && !loading ? ( // Muestra si no hay productos y no está cargando
            ...
            <>
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-between p-6 flex-grow">
                        ...
                        <p className="text-xs text-gray-800 mt-1">
                          {representative.id_product}
                        </p>
                        <div className="mt-4 mb-4 flex justify-between items-center">
                          <button
                            onClick={() =>
                              navigate(
                                `/product/${representative.id_product}`,
                                { state: { group } }
                              )
                            }
                      ...
                      {userInfo && userInfo.role === "Admin" && (
                        <div className="absolute top-2 right-2 flex space-x-2">
                          <button
                            ...
                            onClick={() =>
                              handleEditProduct(representative.id_product)
                            }
                          >
                            <FiEdit size={20} />
                          </button>
                          <button
                            ...
                            onClick={() =>
                              handleDeleteProduct(representative.id_product)
                            }
                          >
                            <FiTrash size={20} />
                          </button>
              ...
              {visibleCount >= uniqueGroups.length &&
